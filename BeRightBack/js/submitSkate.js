    ...
    function myFunction() {
		...
		var e = document.getElementById("skatetid");
        localStorage.setItem('skatetid',e.value);
        e1 = localStorage.getItem('skatetid');
        console.log(e1);
        ...
        function relFunction(){
            if(document.getElementById("skatename").value != null){
                a1 = localStorage.getItem('skatename');
